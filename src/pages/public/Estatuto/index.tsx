  ...
  return (
    <div className="pt-16 min-h-screen bg-offwhite">
      <div className="container-site max-w-2xl py-20 text-center">
        ...
        <h1 className="text-3xl md:text-4xl heading-editorial text-graphite-900 text-balance">Estatuto do Grupo GCasa</h1>
        <p className="mt-5 text-lg text-graphite-700 leading-relaxed">
          Estamos organizando a publicação do estatuto social do Grupo GCasa nesta página. Se precisar do documento agora, fale com a nossa equipe.
        </p>
        <Link
          to="/contato"
