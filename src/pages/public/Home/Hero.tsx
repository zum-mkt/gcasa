...
export function Hero() {
  ...
  return (
    <section className="relative min-h-[70vh] flex flex-col bg-navy-900 overflow-hidden">
      {hero.image_url && (
        <img
          src={hero.image_url}
          alt=""
      ...
      <div className="relative z-10 container-site flex-1 flex items-center py-20">
